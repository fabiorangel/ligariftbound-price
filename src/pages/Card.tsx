        ...
        <div className="space-y-6">
          ...
          {indexEntry && (
            <div className="p-4 rounded-xl bg-surface-800 border border-surface-600">
              ...
              {indexEntry.liga_url && (
                <a
                  href={indexEntry.liga_url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-3 inline-flex items-center gap-1.5 text-xs text-zinc-500 hover:text-gold-400 transition-colors"
                >
                  Ver no LigaRiftbound
